// 更新日志:
//2022.12.12 v1.7.0 解决滑动验证问题

// 学习强国 [学习小熊] PC端桌面浏览器扩展 当前目录内压缩包下载后解压使用
// 安装扩展后，点击浏览器右上角图标自动打开 [https://www.xuexi.cn] 网站完成学习任务
// 最新版本 [学习小熊] 火狐 Chrome 360 Edge QQ 浏览器扩展插件 扫码登录官网学习 Andriod/IOS设备均适用
